...
export const PricingHeroSection = () => {
  ...
  return (
    <section className="min-h-fit w-full bg-bg-pricing-main bg-cover bg-center bg-no-repeat">
      ...
      <div className="relative mx-auto flex min-h-[490px] md:min-h-[calc(100dvh-83px)] w-full max-w-screen-xl flex-col items-center px-8 max-sm:pb-12 lg:flex-row lg:px-[3.5rem]">
        ...
        <div className="h-fit w-full flex-1 max-[780px]:order-1 lg:w-1/2 mt-4 md:mt-0">
