...
//   const submit: SubmitHandler<ResetFormProps> = async (data) => {
//     const resetPwdState = useSCStore.getState().resetPwdState;
//     console.log("working");

//     if (!resetPwdState.otp || !resetPwdState.userIdentity) return;
//     const dataToSend = {
...
import { resetPassword } from "@/mutation";
import { Toaster, toast } from "sonner";
import { useRouter } from "next/navigation"; // Using useRouter instead of redirect
import { useSCStore } from "@/store";
