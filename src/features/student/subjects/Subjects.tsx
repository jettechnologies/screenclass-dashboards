      ...
      <div className="w-full p-0 lg:w-full">
        <div className="flex h-full w-full flex-col items-center bg-[#ffffff]">
          <div className="h-full w-full">
            ...
            <section className="mb-16 mt-10 flex w-full flex-col flex-wrap items-center gap-4 space-y-8 px-4 sm:space-y-0 md:mb-16 md:flex-col lg:mb-0 lg:flex-row lg:px-7">
              {isLoading ? (
                ...
                subjects.map((subject) => (
                  <SubjectCard
                    key={subject._id}
                    href={`/dashboard/student/subjects/topics/${subject._id}`}
