...
//   return (
//     <div
//       className={`relative w-full overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700 h-[${height || "17px"}] bg-[${!isGradient ? progressColor : ""}] border-2 border-black`}
//     >
//       <div
...
export const Progress = ({
  ...
  return (
    <div
      className={`relative w-full overflow-hidden rounded-full bg-gray-200 h-[${height || "17px"}] bg-[${!isGradient ? progressColor : ""}]`}
    >
      <div
        className="flex h-full items-center justify-center rounded-full p-0.5 text-center text-xs font-medium leading-none text-blue-100 transition-all duration-300 ease-in-out"
        style={{
          width: `${progress}%`,
          background: isGradient ? progressColor : undefined,
        }}
